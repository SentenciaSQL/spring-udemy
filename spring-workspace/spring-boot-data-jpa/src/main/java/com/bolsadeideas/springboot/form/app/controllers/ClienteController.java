...
public class ClienteController {
	...
	public String ver(@PathVariable(value = "id") Long id, Map<String, Object> model, RedirectAttributes flash) {
		...
		if (cliente == null) {
			flash.addFlashAttribute("error", "El cliente no existes en la base de datos");
	...
	public String editar(@PathVariable(value = "id") Long id, Map<String, Object> model, RedirectAttributes flash) {
		...
		if (id > 0) {
			...
			if (cliente == null) {
				flash.addFlashAttribute("error", "El ID del clinete no existe en la base de datos!");
				return "redirect:/listar";
			}
		} else {
			flash.addFlashAttribute("error", "El ID del clinete no puede ser cero!");
			return "redirect:/listar";
		}
		model.put("cliente", cliente);
